  ...
  <div class="container">
    <div class="row align-items-center">
      ...
      <div class="col-md-6 order-md-1">
        ...
        <a href="dress-material.php" class="btn btn-primary">Shop Now</a>
      </div>
    </div>
  </div>
</section>
...
<!-- MODAL (same as customizable.php) -->
...
<script>
// SAME JS AS customizable.php (quick-view, modal, payNow link update)
</script>
